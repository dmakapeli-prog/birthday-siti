    ...
    <div className="flex flex-col items-center justify-center h-full px-6">
      <div className="w-full max-w-2xl rounded-2xl p-8 md:p-12 relative overflow-hidden"
        ...
        <div className="text-center mb-8">
          <h2 className="font-cormorant italic" style={{ fontSize: 'clamp(2.5rem,5vw,4rem)', fontWeight: 600 }}>Happy Birthday</h2>
          <p className="text-xs tracking-[4px] uppercase mt-2" style={{ color: 'var(--rose)', fontFamily: 'sans-serif' }}>HAPPY BIRTHDAY SAYANGKUUU 🤍</p>
        </div>

        <div className="text-left leading-relaxed" style={{ fontSize: 'clamp(1rem,1.8vw,1.15rem)', color: 'rgba(255,255,255,0.88)', fontFamily: 'Lato, sans-serif', fontWeight: 300, lineHeight: 1.9 }}>
